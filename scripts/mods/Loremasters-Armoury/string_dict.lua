...
local desc_strings = {
    ...
    Kruber_Hippogryph_helm_devoted = "Helmet of an audacious knight, acclaimed valiant after slaying a mighty beast.",
    Kruber_Hippogryph_helm_faithful = "Helmet of an audacious knight, acclaimed valiant after slaying a mighty beast.",
    Kruber_Hippogryph_helm_merciful = "Helmet of an audacious knight, acclaimed valiant after slaying a mighty beast.",
    ...
    Kruber_Worthy_helm_devoted = "A knight's headpiece, as stalwart and true as he who dons it.",
    Kruber_Worthy_helm_faithful = "A knight's headpiece, as stalwart and true as he who dons it.",
    Kruber_Worthy_helm_merciful = "A knight's headpiece, as stalwart and true as he who dons it.",
...
mod.krub_hats = {
    ...
    questing_knight_hat_0003 = {
        ...
        Kruber_Hippogryph_helm_devoted = "Hippogryph Helm (Devoted)",
        Kruber_Hippogryph_helm_faithful = "Hippogryph Helm (Faithful)",
        Kruber_Hippogryph_helm_merciful = "Hippogryph Helm (Merciful)",
    },
    ...
    questing_knight_hat_0000 = {
        ...
        Kruber_Worthy_helm_devoted = "Helm of the Worthy (Devoted)",
        Kruber_Worthy_helm_faithful = "Helm of the Worthy (Faithful)",
        Kruber_Worthy_helm_merciful = "Helm of the Worthy (Merciful)",
    },
    huntsman_hat_0001 = {
