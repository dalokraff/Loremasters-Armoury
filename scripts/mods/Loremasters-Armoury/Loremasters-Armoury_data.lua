		...
		["sub_widgets"] = {
			{
				...
				["options"] = {
					...
					{text = "Kruber_bret_shield_hero1_Alberic01",   value = "Kruber_bret_shield_hero1_Alberic01"},
			...
			},
			{
				...
				["widget_type"] = "dropdown",
				["default_value"] = "default",
				["text"] = "es_1h_sword_shield_skin_02_runed_01",
				["tooltip"] = "Choose active skin for Recruit's Longsword and Shield",
				["options"] = {
					{text = "Reikland Captain's Shield",   value = "Kruber_empire_shield_basic1"},
					{text = "Wolfenburg Guard Shield",   value = "Kruber_empire_shield_basic2"},
			...
			},
			{
				...
				["widget_type"] = "dropdown",
				["default_value"] = "default",
				["text"] = "es_1h_sword_shield_skin_03_runed_01",
				["tooltip"] = "Choose active skin for Soldier's Longsword and Shield",
				["options"] = {
					{text = "Reikland Captain's Shield",   value = "Kruber_empire_shield_basic1"},
					{text = "Wolfenburg Guard Shield",   value = "Kruber_empire_shield_basic2"},
			...
			},
			{
				...
				["widget_type"] = "dropdown",
				["default_value"] = "default",
				["text"] = "es_1h_sword_shield_skin_03_runed_02",
				["tooltip"] = "Choose active skin for Soldier's Longsword and Shield",
				["options"] = {
					{text = "Reikland Captain's Shield",   value = "Kruber_empire_shield_basic1"},
					{text = "Wolfenburg Guard Shield",   value = "Kruber_empire_shield_basic2"},
			...
			},
			{
				...
				["options"] = {
					...
					{text = "Griffon Gate Sentry-Shield (new mesh)",   value = "Kerillian_elf_shield_basic2_mesh"},
