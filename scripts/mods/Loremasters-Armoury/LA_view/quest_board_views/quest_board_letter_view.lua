...
QuestBoardLetterView.setup_reward_display = function (self, title_text, description_text, icon)
	...
	local sub_quest_reward_name = sub_quest_data.reward
	local reward_data = ItemMasterList[sub_quest_reward_name]
...
QuestBoardLetterView.setup_sub_quest_display = function (self, title_text, description_text, icon)
	...
	local main_quest = QuestLetters[active_quest]
	local sub_quest_data = main_quest[unit_name]
	local sub_quest_brief = sub_quest_data.mission_brief
	local achievement_data = AchievementTemplates.achievements[sub_quest_brief]
